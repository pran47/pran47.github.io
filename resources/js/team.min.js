!function(document, window, $) {
    ...
    function() {
        var handleSelective=function(handleSelectiveItem) {
            var member=[ {
                id: "uid_1", name: "Herman Beck", avatar: "../global/portraits/1.jpg"
            }
            ,
            {
                id: "uid_2", name: "Mary Adams", avatar: "../global/portraits/2.jpg"
            }
            ,
            {
                id: "uid_3", name: "Caleb Richards", avatar: "../global/portraits/3.jpg"
            }
            ,
            {
                id: "uid_4", name: "June Lane", avatar: "../global/portraits/4.jpg"
            }
            ],
            items=handleSelectiveItem;
            $('[data-plugin="jquery-selective"]').selective( {
                namespace:"addMember", local:member, selected:items, buildFromHtml:!1, tpl: {
        ...
        $("#addNewItemBtn").on("click", function() {
            ...
            , {
                id: "uid_2", name: "Caleb Richards", avatar: "../global/portraits/2.jpg"
            }
            ];
        ...
        $(".list-group-item").on("click", function() {
            var oldTitle=$(this).find(".item-title").text(), dueDate=$(this).find("span").text();
